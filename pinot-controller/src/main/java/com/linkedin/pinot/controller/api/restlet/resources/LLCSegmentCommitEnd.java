...
public class LLCSegmentCommitEnd extends ServerResource {
  ...
  public LLCSegmentCommitEnd() throws IOException {
  ...
  public Representation get() {
    ...
    if (!new File(segmentCompletionProtocol.getTableDirectory(), _segmentNameStr).exists()) {
      LOGGER.error("File does not exist " + _segmentNameStr);
      return new StringRepresentation(SegmentCompletionProtocol.RESP_FAILED.toJsonString());
    }
